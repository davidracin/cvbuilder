      ...
      <div className="max-w-7xl mx-auto">
        ...
        {cvs.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {cvs.map((cv) => (
              <Card key={cv.id} className="overflow-hidden hover:shadow-lg transition-shadow">
                <CardContent className="p-0">
                  {/* Thumbnail */}
                  <div className="relative aspect-[3/4] bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600">

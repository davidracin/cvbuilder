...
export const exportToPDF = async (cvData, templateName, filename = 'cv.pdf', designSettings = null) => {
  ...
  console.log('Design Settings:', finalDesignSettings);
 ...
 */
export const getAvailableTemplates = () => Object.keys(PDF_TEMPLATES);
 ...
 */
export const getDefaultDesignSettings = (templateName) => {
  return DEFAULT_DESIGN_SETTINGS[templateName] || DEFAULT_DESIGN_SETTINGS.moderni;
};

export default { exportToPDF, getAvailableTemplates, getDefaultDesignSettings };
